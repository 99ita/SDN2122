...
def build():
    ...
    switchL3 = net.addSwitch('sL3', dpid = '10')
    ...
    #Add links
    net.addLink(switchL3, switchL2_1, delay='5ms')
    net.addLink(switchL3, switchL2_2)
    net.addLink(switchL3, switchL2_3)
    ...
    net.addLink(switchL2_2, host6, delay='5ms')
    
    net.addLink(switchL2_3, host7)
    net.addLink(switchL2_3, host8)
    net.addLink(switchL2_3, host9, loss=10)
